...
import com.serivce.emp.impl.AbsEmployeeServiceImpl;
import com.serivce.emp.impl.EmployeeSeriverImpl;
...
public class Main {
    ...
    private static void testByBeanImpl() {
        ...
        EmployeeSeriverImpl employeeService = context.getBean("emp", EmployeeSeriverImpl.class);
